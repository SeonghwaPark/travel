...
|---|---|
| 07:00 | 서울 출발 |
| 09:25~10:00 | 옛길박물관 · 은행나무길 · **제1관문 주흘관** |
| 10:00~11:45 | **문경새재** — 🚋**A코스** 전동차 → 오픈세트장 → 걸어서 제1관문 하산 |
| 12:00~13:00 | 문경 점심 (약돌돼지) |
| 13:25~15:00 | 🏯 **고모산성 + 토끼비리** |
| 15:50~16:30 | 🛕 **미륵대원지** |
| 17:20 | 연수원 체크인 / 저녁 |

> ⚠️ **토요일이라 C코스(제2관문)는 오전·오후 각 2회뿐**입니다. 위 표는 **A코스(오픈세트장) 기준**으로 안전하게 짰습니다. 054-572-6768로 오전 회차 시각을 확인해서 탈 수 있으면 C코스로 올려잡으세요.
...
3. **토요일에 가면 C코스가 오전·오후 각 2회뿐**입니다. 1박2일(토요일 출발) 버전은 회차 시각을 **반드시 전화로 확인**하거나, 처음부터 A코스로 계획하세요.
